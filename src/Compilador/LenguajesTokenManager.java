...
public class LenguajesTokenManager implements LenguajesConstants {
	...
	public static final String[] jjstrLiteralImages = { "", null, null, null, null, "\53", "\55", "\52", "\57", null,
			null, "\73", "\50", "\51", };
	...
	public LenguajesTokenManager(SimpleCharStream stream) {
	...
	public LenguajesTokenManager(SimpleCharStream stream, int lexState) {
		this(stream);
		SwitchTo(lexState);
	}
